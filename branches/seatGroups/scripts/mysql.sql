...
create table seatGroups (
	id int unsigned not null primary key auto_increment,
	name varchar(128) not null,
	numberOfSeats tinyint unsigned not null default 1,
...
create table seatGroup_requirements (
	seatGroup_id int unsigned not null,
	requirement_id int unsigned not null,
	primary key (seatGroup_id,requirement_id),
	foreign key (seatGroup_id) references seatGroups(id),
