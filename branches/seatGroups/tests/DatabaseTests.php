...
require_once 'DatabaseTests/SeatGroupDbTest.php';
require_once 'DatabaseTests/SeatGroupListDbTest.php';
...
class DatabaseTests extends PHPUnit_Framework_TestSuite
{
    ...
    public static function suite()
    {
		...
		$suite->addTestSuite('SeatGroupDbTest');
		$suite->addTestSuite('SeatGroupListDbTest');
