...
if (isset($_POST['member']))
{
	...
	try
	{
		$user->save();
		$member->save();
		Header('Location: '.$member->getSeatGroup()->getURL());
		exit();
	}
...
$template->blocks[] = new Block('seats/groupInfo.inc',array('seatGroup'=>$member->getSeatGroup()));

$seats = new Block('seats/seatList.inc');
$seats->seatGroup = $member->getSeatGroup();
